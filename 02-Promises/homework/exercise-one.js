...
function problemC () {
  ...
  promisifiedReadFile('poem-one/stanza-02.txt')
  .then((p1s2)=>{blue(p1s2);return promisifiedReadFile('poem-one/stanza-03.txt')})
  .then((p1s3)=>{blue(p1s3);return "done"})
  .then((done)=>blue(done))
...
function problemE () {
  ...
  // promise version
  promisifiedReadFile('poem-one/stanza-03.txt')
  .then((p1s3)=>{blue(p1s3);return promisifiedReadFile('poem-one/stanza-s.txt')})
  .then((p1s4)=>blue(p1s4))
  .catch((e)=>magenta(new Error(e)))
...
function problemF () {
  ...
  .then((p1s3)=>{
    blue(p1s3);
    return promisifiedReadFile('poem-one/stanza-05.txt')
  })
